...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # calculating how many images we have in result_dic dictionary
    results_stats_dic["n_images"] = len(results_dic)

    # calculating the images that are not dogs by subtracting notdog images from total images
    ...
    # calculate the percentage of correct breed dogs
